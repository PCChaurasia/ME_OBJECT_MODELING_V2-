...
public class ContestService implements IContestService {
    ...
    private List<Question> pickQuestionsList(final List<Question> questions,final Integer numQuestion){
        if (questions == null || numQuestion == null || numQuestion <= 0 || questions.size() == 0) {
            return Collections.emptyList();
        }
        List<Question> pickRandomQuestions = new ArrayList<>();
        Collections.shuffle(questions);
        pickRandomQuestions.addAll(questions.subList(0, numQuestion));
